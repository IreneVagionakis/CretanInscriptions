...
<xsl:stylesheet exclude-result-prefixes="#all"
  ...
  <xsl:template match="/">
    ...
    <xsl:if test="normalize-space($free-text)">
      <doc>
        ...
        <xsl:call-template name="field_project_no" />
        <!-- Facets. -->
        ...
        <xsl:call-template name="field_support_type" />
  ...
  <xsl:template match="tei:repository[@ref]" mode="facet_current_location">
    <field name="current_location">
      <xsl:variable name="rep-id" select="substring-after(@ref,'#')"/>
      <xsl:value-of select="document('../../../content/xml/authority/rep.xml')//tei:item[@xml:id=$rep-id]/tei:term[@xml:lang=$language]"/>
    </field>
  </xsl:template>
  ...
  <xsl:template match="tei:objectType[@ref]" mode="facet_support_type">
    <field name="support_type">
      <xsl:variable name="mon-id" select="substring-after(@ref,'#')"/>
      <xsl:value-of select="document('../../../content/xml/authority/mon.xml')//tei:item[@xml:id=$mon-id]/tei:term[@xml:lang=$language]"/>
    </field>
  </xsl:template>

  <xsl:template match="tei:persName[@type='attested']/tei:name[@nymRef]" mode="facet_mentioned_people">
  ...
  <xsl:template name="field_project_no">
    <field name="project_no">
      <xsl:variable name="idno" select="/tei:*/tei:teiHeader/tei:fileDesc/tei:publicationStmt/tei:idno[@type='projectNo']" />
      <xsl:choose>
        <xsl:when test="normalize-space($idno)">
          <xsl:value-of select="$idno" />
        </xsl:when>
  ...
  <xsl:template name="field_provenance">
    <xsl:apply-templates mode="facet_provenance" select="//tei:teiHeader/tei:fileDesc/tei:sourceDesc/tei:msDesc/tei:history/tei:origin/tei:origPlace[@ref]" />
  </xsl:template>
  
  <xsl:template name="field_current_location">
    <xsl:apply-templates mode="facet_current_location" select="//tei:teiHeader/tei:fileDesc/tei:sourceDesc//tei:repository[@ref]"/>
  </xsl:template>
  ...
  <xsl:template name="field_support_type">
    <xsl:apply-templates mode="facet_support_type" select="//tei:teiHeader/tei:fileDesc/tei:sourceDesc/tei:msDesc/tei:physDesc/tei:objectDesc/tei:supportDesc/tei:support//tei:objectType[@ref]" />
  </xsl:template>
